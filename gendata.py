...
tickets.append(Ticket('T1','F112','P27','Low','Hengja upp jólaskrautið','Þar sem hótelið er ekki að nýta öll 190 Mega vöttin sem OK-650VV(https://en.wikipedia.org/wiki/OK-650_reactor) getur búið til hefur verið ákv. að á hverju ári skuli sett upp einhver sú skrautlegasta jólaskrauts útstilling sem sögur fara af.Skal hefast handa við að hengja upp skrautið 1 nóv. ár hvertog svo aftur að taka það niður 10 jan. ár hvert. ','open',False,0,'10-12-2024','01-11-2024',None,None,0,None,None,None,0))
tickets.append(Ticket('T2','F112','P27','High','Gera kjarnaofn subcritical.','OK-650VV kjarnaofninn er voru hannaðir um 1970. Þeir eiga það þó til að ofhitna ef þeim er ekki viðhaldið sem skyldi.Reglulega (amk. 1 sinni í viku) þarf sáldra smá Borax (sem er bara málmurin Boron) í kerfið (sjá https://www.borax.com/products/applications/nuclear-energy#:~:text=How%20does%20boron%20help%20control,stopping%20the%20reaction%2C%20if%20needed.). ATH! Við þetta þarf verktaka sem á góðan gúmígalla því þetta er allt frekar blautt og heitt, og svo er ekki verra að vitaeitthvað hvað maður er að gera. ','Open',True,7,'13-12-2024',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T3','F2','P2','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T4','F3','P3','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T5','F4','P4','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T6','F5','P5','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T7','F6','P6','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T8','F7','P7','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))

tickets.append(Ticket('T9','F8','P8','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T10','F9','P9','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T11','F10','P10','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T12','F11','P11','Low','Kæla niður snjóhús og stoppa í glufur','Rétt yfir há sumartímann, frá 15 júlí til 25 ágúst, þarf að dittaað iGlú-ville húsunum (öllum). Aðalega þarf að bæta við snjó og passa að það sé ekki komin göt á veggi osfrv.','Pending',True,1,'15-07-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T13','F12','P16','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T14','F13','P17','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T15','F14','P18','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T16','F15','P19','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))

tickets.append(Ticket('T17','F16','P20','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T18','F17','P21','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T19','F18','P22','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.n','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T20','F19','P23','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T21','F20','P24','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.n','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T22','F21','P25','Low','Slá og reita arfa af moldarhúsum.','Yfir sumartímann þarf slá gras og reita arfa af moldrahúsunum amk. einusinni í viku. Gildir þetta frá 1 maí til 30 sept.','Pending',True,15,'01-05-2025',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T23',None,'P26','Low','Gluggaþvottur','Einusinni í viku þarf að þrífa glugga á öllum ofantöldum fasteignum. Öll hús nema igloo, kafbáturinn og moldarhúsin, en ekkert af þeim er með glugga.','Open',True,7,'13-12-2024',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T24',None,'P12','Low','Gluggaþvottur','Einusinni í viku þarf að þrífa glugga á öllum ofantöldum fasteignum. Öll hús nema igloo, kafbáturinn og moldarhúsin, en ekkert af þeim er með glugga.','Pending',True,7,'17-12-2024',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T25',None,'P1','Low','Gluggaþvottur','Einusinni í viku þarf að þrífa glugga á öllum ofantöldum fasteignum. Öll hús nema igloo, kafbáturinn og moldarhúsin, en ekkert af þeim er með glugga.','Open',True,7,'09-12-2024',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T26','F30','P27','High','Ticket title','Ticket description','Open',False,0,'16-12-2024',None,None,None,0,None,None,None,0))
tickets.append(Ticket('T27','F30','P27','High','Ticket title','Ticket description','Open',False,0,'16-12-2024',None,None,None,0,None,None,None,0))
...
staff.append(Staff('S10','D1','BossMan','101010-1119','Heimilisfang 2, Reykjavík','+354 555-5555','+354 777-7777','Boss','Man','Prufuyfirmaður',True))
staff.append(Staff('S11','D1','Pleb','111110-1229','Heimilisfang 1, Reykjavík','+354 444-5555','+354 888-7777','Pleb','1234','Prufuundirmaður',False))
